...
| ☀️ Φως | Επίπεδο φωτός (raw) |
| 🔊 Ήχος | Ένταση ήχου (raw) |
...
> 💡 Πριν πατήσεις ΕΚΚΙΝΗΣΗ, κράτα τη συσκευή **οριζόντια** (οθόνη προς τα πάνω) — η τρέχουσα θέση χρησιμοποιείται ως σημείο αναφοράς (calibration) για το γκάζι, οπότε αν η συσκευή είναι γερμένη κατά την εκκίνηση, το γκάζι δεν θα δουλεύει σωστά.
...
<details>
<summary>📋 Οδηγός Συνδέσεων Εξαρτημάτων</summary>

| Εξάρτημα | Port | Περιγραφή |
|---|---|---|
| 📡 Αισθητήρας Υπερήχων | `A0/D2` | Μέτρηση απόστασης εμποδίων |
| 📏 Αισθητήρας Γραμμής | `A1/A2/A3` | Παρακολούθηση γραμμής |
| ☀️ Αισθητήρας Φωτός | `I2C` | Μέτρηση έντασης φωτός |
| 🎤 Αισθητήρας Ήχου | `A6/A7` | Ανίχνευση ήχου / παλαμάκια |
| 👆 Αισθητήρας Αφής | `D11` | Ανίχνευση αγγίγματος |
| 🌈 RGB LED | `D12` | Πολύχρωμη ένδειξη κατάστασης |
| ⚪ Λευκό LED | `D9/D10` | Φωτισμός κίνησης |
...
- 🤖🤖 Υποστηρίζει flash σε **πολλά ρομπότ** αν συνδεθούν διαδοχικά (χρήσιμο σε σχολικό εργαστήριο με πολλά R2).
